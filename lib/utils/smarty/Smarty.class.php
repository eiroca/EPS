...
class Smarty {
   ...
   * If true, then If-Modified-Since headers
   ...
   * When enabled, many things are restricted
  ...
  var $security_settings = array (
      ...
      ), 'INCLUDE_ANY' => false, 'PHP_TAGS' => false, 'MODIFIER_FUNCS' => array (
          'count'
      ), 'ALLOW_CONSTANTS' => false, 'ALLOW_SUPER_GLOBALS' => true
  );
   ...
   * are uses as request-vars or $_*[]-vars.
   * note: if
   ...
   * templates_c/ directories.
   * sub directories better organized, but
   ...
   * tempalates or not.
   * Normally you would never allow this since that is
   ...
   */
  var $_plugins = array (
      'modifier' => array (), 'function' => array (), 'block' => array (), 'compiler' => array (), 'prefilter' => array (), 'postfilter' => array (), 'outputfilter' => array (), 'resource' => array (), 'insert' => array ()
  );
    ...
    switch ($type) {
      case 'output' :
        $_params = array (
            'plugins' => array (
                array (
                    $type . 'filter', $name, null, null, false
                )
            )
        );
  ...
  function clear_cache($tpl_file = null, $cache_id = null, $compile_id = null, $exp_time = null) {
    ...
    if (!empty($this->cache_handler_func)) {
      ...
      $_params = array (
          'auto_base' => $this->cache_dir, 'auto_source' => $tpl_file, 'auto_id' => $_auto_id, 'exp_time' => $exp_time
      );
  ...
  function clear_compiled_tpl($tpl_file = null, $compile_id = null, $exp_time = null) {
    ...
    $_params = array (
        'auto_base' => $this->compile_dir, 'auto_source' => $tpl_file, 'auto_id' => $compile_id, 'exp_time' => $exp_time, 'extensions' => array (
            '.inc', '.php'
        )
    );
    require_once (SMARTY_CORE_DIR . 'core.rm_auto.php');
  ...
  function template_exists($tpl_file) {
    $_params = array (
        'resource_name' => $tpl_file, 'quiet' => true, 'get_source' => false
    );
  ...
  function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false) {
    ...
    if ($this->debugging) {
      ...
      $this->_smarty_debug_info[] = array (
          'type' => 'template', 'filename' => $resource_name, 'depth' => 0
      );
    ...
    if ($this->caching) {
      ...
      $_params = array (
          'tpl_file' => $resource_name, 'cache_id' => $cache_id, 'compile_id' => $compile_id, 'results' => null
      );
      require_once (SMARTY_CORE_DIR . 'core.read_cache_file.php');
    ...
    if ($display && !$this->caching && count($this->_plugins['outputfilter']) == 0) {
      ...
      foreach ((array)$this->_plugins['outputfilter'] as $_output_filter) {
        $_smarty_results = call_user_func_array($_output_filter[0], array (
            $_smarty_results, &$this
        ));
      }
    }
    if ($this->caching) {
      $_params = array (
          'tpl_file' => $resource_name, 'cache_id' => $cache_id, 'compile_id' => $compile_id, 'results' => $_smarty_results
      );
  ...
  function config_load($file, $section = null, $scope = 'global') {
    ...
    smarty_function_config_load(array (
        'file' => $file, 'section' => $section, 'scope' => $scope
    ), $this);
  }
  ...
  function _is_compiled($resource_name, $compile_path) {
    if (!$this->force_compile && file_exists($compile_path)) {
      if (!$this->compile_check) {
        ...
        if (!$this->_fetch_resource_info($_params)) {return false;}
  ...
  function _compile_resource($resource_name, $compile_path) {
    ...
    if ($this->_compile_source($resource_name, $_source_content, $_compiled_content, $_cache_include)) {
      ...
      $_params = array (
          'compile_path' => $compile_path, 'compiled_content' => $_compiled_content
      );
  ...
  function _unlink($resource, $exp_time = null) {
    if (isset($exp_time)) {
      if (time() - @filemtime($resource) >= $exp_time) {return @unlink($resource);}
    }
    else {
  ...
  function _smarty_include($params) {
    if ($this->debugging) {
      ...
      $this->_smarty_debug_info[] = array (
          'type' => 'template', 'filename' => $params['smarty_include_tpl_file'], 'depth' => ++$this->_inclusion_depth
      );
